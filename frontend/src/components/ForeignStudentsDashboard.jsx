...
// Generated by scripts/build_foreign_students.py: counts only, no row-level records.
const loadData = () => import('../data/foreign-students.json').then((module) => module.default)
...
export default function ForeignStudentsDashboard() {
  ...
  useEffect(() => {
    ...
    loadData()
      ...
      .catch(() => { if (isCurrent) setError('The foreign students data could not be loaded. Reload the page to try again.') })
    ...
    <>
      ...
      <main id="dashboard-content" tabIndex={-1} className="mx-auto max-w-[1600px] px-4 py-5 outline-none sm:px-6 sm:py-7 lg:px-8">
        ...
        <section className="mt-7" aria-busy={!data && !error} aria-labelledby="foreign-students-title">
          ...
          {error ? (
            <div role="alert" className="mt-5 flex items-start gap-3 rounded-2xl border border-red-200 bg-red-50 p-5 text-red-900">
